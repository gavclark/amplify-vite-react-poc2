...
export declare type KpiDefinitionCreateFormInputValues = {
    kpiCode?: string;
    kpiArea?: string;
    kpiTitle?: string;
    kpiDataType?: string;
...
export declare type KpiDefinitionCreateFormValidationValues = {
...
export declare type KpiDefinitionCreateFormOverridesProps = {
    KpiDefinitionCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type KpiDefinitionCreateFormProps = React.PropsWithChildren<{
    overrides?: KpiDefinitionCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: KpiDefinitionCreateFormInputValues) => KpiDefinitionCreateFormInputValues;
    onSuccess?: (fields: KpiDefinitionCreateFormInputValues) => void;
    onError?: (fields: KpiDefinitionCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: KpiDefinitionCreateFormInputValues) => KpiDefinitionCreateFormInputValues;
    onValidate?: KpiDefinitionCreateFormValidationValues;
} & React.CSSProperties>;
export default function KpiDefinitionCreateForm(props: KpiDefinitionCreateFormProps): React.ReactElement;
